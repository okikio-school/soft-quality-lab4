...
public class BinaryAPIControllerTest {
    ...
    public void multiply() throws Exception {
        this.mvc.perform(get("/multiply").param("operand1","1010").param("operand2","101"))//.andDo(print())
            .andExpect(status().isOk())
    ...
    public void multiply2() throws Exception {
        this.mvc.perform(get("/multiply_json").param("operand1","1010").param("operand2","101"))//.andDo(print())
            .andExpect(status().isOk())
